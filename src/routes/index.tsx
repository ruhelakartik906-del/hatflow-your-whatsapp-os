...
function Index(){
  ...
  return <main className="overflow-hidden bg-background text-foreground">
    ...
    <section className="final-cta" id="contact"><div className="cta-grid"/><span className="eyebrow">START WITH HATFLOW</span><h2>Ready to Turn WhatsApp Into Your Business Operating System?</h2><p>Automate conversations. Capture leads. Manage customers. Connect your tools.</p><div><Button size="lg" onClick={()=>setInquiry("started")}>Get Started Now <ArrowRight/></Button><Button size="lg" variant="outline" onClick={()=>setInquiry("expert")}>Talk to an Expert</Button></div></section>
    ...
    <Button size="icon" className="floating-contact" aria-label="Talk to HATFLOW" onClick={()=>setInquiry("expert")}><MessageCircle/></Button>
