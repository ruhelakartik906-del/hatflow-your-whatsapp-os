...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HATFLOW" },
      { name: "description", content: "WhatsApp Business automation, CRM and AI in one operating system." },
      { name: "author", content: "UnknownHat Agency" },
      { property: "og:title", content: "HATFLOW" },
      { property: "og:description", content: "WhatsApp Business automation, CRM and AI in one operating system." },
      ...
      { name: "twitter:title", content: "HATFLOW" },
      { name: "twitter:description", content: "WhatsApp Business automation, CRM and AI in one operating system." },
