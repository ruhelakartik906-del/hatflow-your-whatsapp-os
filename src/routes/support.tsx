...
function SupportPage() { return <LegalPage title="Support"><h2>How can we help?</h2><p>For help with your account, WhatsApp connection, billing, integrations or automations, contact the Hatflow team.</p><a className="legal-contact" href="mailto:support@hatflow.in">support@hatflow.in</a><h2>When you contact us</h2><p>Please include your account email and a short description of the issue. Do not share passwords, verification codes or payment credentials.</p></LegalPage>; }